const portfolioData = [
    ...
    // Konferencje
    // ==========================================
    { id: "conf-ostrow-7", line: "conferences", dateLabel: "Nov 2023", date: "2023-11", title: "7th Greater Poland Meeting of Pediatric Surgeons", subtitle: "Oral Presentation", description: `<p>CSMD3 gene c.1075G>T variant in two children aged 3 and 7.</p>`, image: "img/VII Ostrów.jpg" },
    { id: "conf-scalpellum-3", line: "conferences", dateLabel: "May 2024", date: "2024-05", title: "SCALPELLUM: 3rd National Student Conference", subtitle: "Oral Presentation", description: `<p>Vomiting in infants as a potential sign of brain disorders: a case report.</p>`, image: "img/III Scalpellum.jpg" },
    ...
    { id: "conf-ostrow-8", line: "conferences", dateLabel: "Nov 2024", date: "2024-11", title: "8th Greater Poland Meeting of Pediatric Surgeons", subtitle: "Oral Presentation", description: `<p>Rare case of arteriovenous malformation in a newborn.</p>`, image: "img/VIII Ostrów.jpg" },
    ...
    { id: "conf-scalpellum-4", line: "conferences", dateLabel: "Apr 2025", date: "2025-04", title: "SCALPELLUM: 4th National Student Conference", subtitle: "Oral Presentation", description: `<p>Abusive Head Trauma in an Infant - Diagnostic Significance of Ocular Fundus Examination: A Case Report.</p>`, image: "img/IV Scalpellum.jpg" },
    ...
    // Kursy
    // ==========================================
    { id: "course-hemato-benign", line: "courses", dateLabel: "Dec 2025", date: "2025-12", title: "Benign Entities in Blood and Bone Marrow", subtitle: "", description: `<p></p>`, image: "img/Benign Entities in Blood and Bone Marrow.jpg" },
    { id: "course-gu-path", line: "courses", dateLabel: "Jan 2026", date: "2026-01", title: "Prostate and Seminal Vesicles", subtitle: "", description: `<p></p>`, image: "img/Prostate and Seminal Vesicles.jpg" },
    { id: "course-hemato-malignant", line: "courses", dateLabel: "Jan 2026", date: "2026-01", title: "Malignant Entities in Blood & Bone Marrow", subtitle: "", description: `<p></p>`, image: "img/Malignant Entities in Blood & Bone Marrow.jpg" }
];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const paddingStart = 150; 
    const paddingEnd = 400;   
